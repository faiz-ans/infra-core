...
# install -m 755 bootstrap/core/core-fan-control /usr/local/sbin/core-fan-control
install -m 755 "${SCRIPT_DIR}/core-fan-control" /usr/local/sbin/core-fan-control
# install -m 644 bootstrap/core/core-fan.service /etc/systemd/system/core-fan.service
