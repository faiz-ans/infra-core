...
| Collabora `Unauthorized WOPI host` (no cert text) | `aliasgroup1` must match `COLLABORATION_WOPI_SRC` (`https://cloud.<DOMAIN>`). `:443` alone is a different host to CODE. Redeploy **collabora**. |
