...
#
#   sudo DATA_ROOT=… bash bootstrap/opencloud/opencloud-adopt-photos.sh park
#   # browser: Spaces → New Space → name exactly photos-<user>; add that user
#   sudo DATA_ROOT=… bash bootstrap/opencloud/opencloud-adopt-photos.sh publish
#   sudo DATA_ROOT=… bash bootstrap/opencloud/opencloud-adopt-photos.sh restore
set -euo pipefail
