...
#   powershell -ExecutionPolicy Bypass -File bootstrap/periphery/periphery-docker-engine.ps1 -DiskSizeGiB 80
#
...
# bootstrap/periphery → catalog root is two levels up.
...
Write-Host "Then start Periphery (bootstrap/periphery/README.md)."
